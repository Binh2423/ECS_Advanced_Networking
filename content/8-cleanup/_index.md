...
{{< workshop-image src="{{ "images/cleanup-order.png" | absURL }}" alt="Cleanup Order" caption="Thứ tự cleanup resources để tránh dependency errors" >}}
...
{{< console-screenshot src="{{ "images/stop-ecs-services.png" | absURL }}" alt="Stop ECS Services" caption="Stop và delete ECS services trước khi cleanup cluster" service="ECS Console" >}}
...
{{< console-screenshot src="{{ "images/delete-alb.png" | absURL }}" alt="Delete ALB" caption="Delete Application Load Balancer và associated resources" service="EC2 Console" >}}
...
{{< console-screenshot src="{{ "images/delete-nat-gateways.png" | absURL }}" alt="Delete NAT Gateways" caption="Delete NAT Gateways và release Elastic IPs" service="VPC Console" >}}
...
{{< console-screenshot src="{{ "images/delete-iam-roles.png" | absURL }}" alt="Delete IAM Roles" caption="Delete IAM roles và policies" service="IAM Console" >}}
...
{{< console-screenshot src="{{ "images/delete-cloudwatch.png" | absURL }}" alt="Delete CloudWatch" caption="Delete CloudWatch logs, alarms và dashboards" service="CloudWatch Console" >}}
...
{{< console-screenshot src="{{ "images/cleanup-verification.png" | absURL }}" alt="Cleanup Verification" caption="Verify tất cả resources đã được cleanup" service="AWS Console" >}}
