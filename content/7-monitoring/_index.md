...
{{< workshop-image src="/ECS_Advanced_Networking/images/advanced-monitoring.png" alt="Advanced Monitoring" caption="Advanced monitoring và troubleshooting tools cho ECS" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/container-insights.png" alt="Container Insights" caption="Container Insights cung cấp detailed metrics cho containers" service="CloudWatch Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/container-insights-data.png" alt="Container Insights Data" caption="Container Insights hiển thị detailed performance metrics" service="CloudWatch Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/xray-service-map.png" alt="X-Ray Service Map" caption="X-Ray Service Map hiển thị service dependencies" service="X-Ray Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/sns-topic.png" alt="SNS Topic" caption="SNS Topic để gửi alerts qua email/SMS" service="SNS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/performance-dashboard.png" alt="Performance Dashboard" caption="Custom dashboard cho performance monitoring" service="CloudWatch Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/ecs-exec.png" alt="ECS Exec" caption="ECS Exec cho phép debug containers trực tiếp" service="ECS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/cloudwatch-insights.png" alt="CloudWatch Insights" caption="CloudWatch Insights để query và analyze logs" service="CloudWatch Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/auto-scaling.png" alt="Auto Scaling" caption="ECS Auto Scaling để tự động scale services" service="ECS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/monitoring-health.png" alt="Monitoring Health" caption="Tổng quan health status của monitoring infrastructure" service="CloudWatch Console" >}}
