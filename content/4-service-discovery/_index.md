...
{{< workshop-image src="/ECS_Advanced_Networking/images/ecs-architecture.png" alt="ECS Architecture" caption="ECS Cluster với Fargate tasks và Service Discovery" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/ecs-console.png" alt="ECS Console" caption="Truy cập ECS Console để tạo cluster mới" service="ECS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/create-cluster.png" alt="Create ECS Cluster" caption="Tạo ECS Cluster với Fargate launch type" service="ECS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/cloud-map.png" alt="Cloud Map Namespace" caption="AWS Cloud Map cung cấp service discovery cho ECS" service="Cloud Map Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/task-definition.png" alt="Task Definition" caption="Task Definition định nghĩa container specifications" service="ECS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/ecs-service.png" alt="ECS Service" caption="ECS Service quản lý và scale containers" service="ECS Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/service-discovery.png" alt="Service Discovery" caption="Service Discovery records trong Cloud Map" service="Cloud Map Console" >}}
...
{{< console-screenshot src="/ECS_Advanced_Networking/images/ecs-services-running.png" alt="ECS Services Running" caption="ECS Services đang chạy với healthy tasks" service="ECS Console" >}}
