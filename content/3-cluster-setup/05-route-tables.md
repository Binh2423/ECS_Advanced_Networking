...
![Route Tables Architecture](/ECS_Advanced_Networking/images/3-cluster-setup/05-routes/route-tables-architecture.png)

## Phương pháp 1: Sử dụng AWS Console

### Bước 1: Truy cập Route Tables Console

![Route Tables Dashboard](/ECS_Advanced_Networking/images/3-cluster-setup/05-routes/01-route-tables-dashboard.png)
...
![Create Route Table Form](/ECS_Advanced_Networking/images/3-cluster-setup/05-routes/02-create-route-table-form.png)
...
![Edit Routes Dialog](/ECS_Advanced_Networking/images/3-cluster-setup/05-routes/03-edit-routes-dialog.png)
...
![Route Tables Complete](/ECS_Advanced_Networking/images/3-cluster-setup/05-routes/05-route-tables-complete.png)
