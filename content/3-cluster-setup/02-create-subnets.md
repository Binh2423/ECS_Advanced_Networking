...
![Subnets Architecture](/ECS_Advanced_Networking/images/3-cluster-setup/02-subnets/subnets-architecture.png)

## Phương pháp 1: Sử dụng AWS Console

### Bước 1: Tạo Public Subnet 1

![Create Subnet Form](/ECS_Advanced_Networking/images/3-cluster-setup/02-subnets/02-create-subnet-form-public1.png)
...
![Subnets List Complete](/ECS_Advanced_Networking/images/3-cluster-setup/02-subnets/03-subnets-list-complete.png)

Tất cả 4 subnets sẽ xuất hiện trong danh sách với đúng CIDR blocks và AZs.

![Public Subnet Details](/ECS_Advanced_Networking/images/3-cluster-setup/02-subnets/04-subnet-details-public.png)

Public subnets sẽ có "Auto-assign public IPv4 address" = Yes.

![Private Subnet Details](/ECS_Advanced_Networking/images/3-cluster-setup/02-subnets/05-subnet-details-private.png)
