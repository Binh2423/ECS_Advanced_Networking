...
![NAT Gateways Architecture]({{ "images/3-cluster-setup/04-nat/nat-gateways-architecture.png" | absURL }})
...
![NAT Gateways Dashboard]({{ "images/3-cluster-setup/04-nat/01-nat-gateways-dashboard.png" | absURL }})
...
![Create NAT Gateway Form]({{ "images/3-cluster-setup/04-nat/02-create-nat-gateway-form.png" | absURL }})
...
![Allocate EIP Dialog]({{ "images/3-cluster-setup/04-nat/03-allocate-eip-dialog.png" | absURL }})
...
![NAT Gateways List]({{ "images/3-cluster-setup/04-nat/04-nat-gateways-list.png" | absURL }})

Cả 2 NAT Gateways sẽ xuất hiện với trạng thái "Available".

![NAT Gateway Details]({{ "images/3-cluster-setup/04-nat/05-nat-gateway-details.png" | absURL }})
