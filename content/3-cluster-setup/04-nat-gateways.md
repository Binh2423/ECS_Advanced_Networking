...
![NAT Gateways Architecture](/ECS_Advanced_Networking/images/3-cluster-setup/04-nat/nat-gateways-architecture.png)
...
![NAT Gateways Dashboard](/ECS_Advanced_Networking/images/3-cluster-setup/04-nat/01-nat-gateways-dashboard.png)
...
![Create NAT Gateway Form](/ECS_Advanced_Networking/images/3-cluster-setup/04-nat/02-create-nat-gateway-form.png)
...
![Allocate EIP Dialog](/ECS_Advanced_Networking/images/3-cluster-setup/04-nat/03-allocate-eip-dialog.png)
...
![NAT Gateways List](/ECS_Advanced_Networking/images/3-cluster-setup/04-nat/04-nat-gateways-list.png)

Cả 2 NAT Gateways sẽ xuất hiện với trạng thái "Available".

![NAT Gateway Details](/ECS_Advanced_Networking/images/3-cluster-setup/04-nat/05-nat-gateway-details.png)
